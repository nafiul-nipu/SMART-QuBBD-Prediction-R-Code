...
###GC: end of ADD 
OPC_final_clinic$Therapeutic.combination
...
fit_ft <- glm(fmla_ft, data=OPC_final_clinic[-nrow(OPC_final_clinic),!colnames(train) %in% c("NA")], family="binomial")
#data=train[,!colnames(train) %in% c("y")]
